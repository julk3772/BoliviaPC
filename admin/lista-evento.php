              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  while($admin = $resultado->fetch_assoc() ){ ?>
                    <tr>
                      <td><?php echo $admin['nombre_evento']; ?></td>
                      <td><?php echo $admin['fecha_evento']; ?></td>
                      <td><?php echo $admin['hora_evento']; ?></td>
                      <td><?php echo $admin['cat_evento']; ?></td>
                      <td><?php echo $admin['nombre_invitado'] . " ". $eventos['apellido_invitado']; ?></td>                   
                      <td>
