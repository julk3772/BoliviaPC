(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var map = L.map('mapa').setView([-16.502319, -68.137504], 16);

        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        }).addTo(map);

        L.marker([-16.502319, -68.137504]).addTo(map)
        .bindPopup('Barbarian Geek<br> Aqui nos puedes encontrar')
        .openPopup();
...
$(function(){
    ...
    // Cuenta Regresiva
    $('.cuenta-regresiva').countdown('2019/08/17 09:00:00', function(event){
